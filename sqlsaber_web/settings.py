"""
Django settings for sqlsaber_web project.
...
INSTALLED_APPS = [
    ...
    "sqlsaber_web.apps.SqlsaberWebConfig",
]
...
MIDDLEWARE = [
    ...
    "sqlsaber_web.middleware.RequireUserConfigurationMiddleware",
...
ROOT_URLCONF = "sqlsaber_web.urls"
...
WSGI_APPLICATION = "sqlsaber_web.wsgi.application"
...
# Email-only login/signup (no username required at signup)
...
# SQLSaber runtime configuration (API keys, models, databases, memory)
# is stored per-user in the database via the /settings wizard.
